...
if pages == 'The Big 4':
    ...
    fig_a2.update_layout(title='<b>Year of disaster</b>', title_x=0.5)
    ...
    fig_b2.update_layout(title='<b>One year after disaster</b>', title_x=0.5)
    ...
    fig_c2.update_layout(title='<b>Two years after disaster</b>', title_x=0.5)
    ...
    fig_d2.update_layout(title='<b>Three years after disaster</b>', title_x=0.5)
