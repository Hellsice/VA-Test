...
if pages == 'Comparison disasters': 
    ...
    data_subtypes_jaar_0 = data_subtypes[data_subtypes['Jaar 0']!=0].sort_values(by='Category')
    data_subtypes_jaar_1 = data_subtypes[data_subtypes['Jaar 1']!=0].sort_values(by='Category')
    data_subtypes_jaar_2 = data_subtypes[data_subtypes['Jaar 2']!=0].sort_values(by='Category')
    data_subtypes_jaar_3 = data_subtypes[data_subtypes['Jaar 3']!=0].sort_values(by='Category')
